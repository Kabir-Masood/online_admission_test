...
if (!empty($_POST)) {
	...
	if (!empty($admin_id) && !empty($password)) {
		...
		$mAdmin->save_admin($admin_id, $password, 1);
...
<head>
	...
	<title>Online Admission Test - Add Admin</title>
	    	...
	    	<div class="container-fluid">
	    		<ol class="breadcrumb">
	    			<li class="breadcrumb-item">
	    				<a href="add_admin.php">Dashboard</a>
	    			</li>
	    				...
	    				<div class="table-responsive">
	    					...
	    					<form action="add_admin.php" method="post">
	    						<div class="form-group">
	    							...
	    							<input type="text" class="form-control" id="admin_id" name="admin_id" placeholder="Enter admin id" required="required">
	    						</div>
	    						<div class="form-group">
